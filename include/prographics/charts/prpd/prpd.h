...
namespace ProGraphics {
  ...
  private:
    ...
    using FrequencyTable = std::array<
      std::array<int, PRPDConstants::AMPLITUDE_BINS>,
      PRPDConstants::PHASE_POINTS
    >;
    ...
    float m_rangeUpdateThreshold = 10.0f; // 更新阈值
    ...
    void clearFrequencyTable(); // 清空频次表
