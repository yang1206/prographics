...
class TextRenderer {
  public:
    ...
    struct TextStyle {
         ...
         * - 非斜体
         */
        TextStyle() : fontFamily("Arial"), fontSize(10), color(Qt::white), bold(false), italic(false) {}
     ...
     * @return 新创建的标签指针
     */
    Label* addLabel(const QString& text, const QVector3D& position, const TextStyle& style = TextStyle());
     ...
     */
    void
    render(QPainter& painter, const QMatrix4x4& viewMatrix, const QMatrix4x4& projectionMatrix, int width, int height);
