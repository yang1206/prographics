...
namespace ProGraphics {
  Axis::Config::Config()
    : length(5.0f),
      xAxisVisible(true), xAxisThickness(2.0f), xAxisColor(1.0f, 0.0f, 0.0f, 1.0f),
      yAxisVisible(true), yAxisThickness(2.0f), yAxisColor(0.0f, 1.0f, 0.0f, 1.0f),
      zAxisVisible(true), zAxisThickness(2.0f), zAxisColor(0.0f, 0.0f, 1.0f, 1.0f) {
  }

  Axis::Config::Config(float length) : Config() {
    this->length = length;
  }

  Axis::Config::Config(float length,
    ...
    : length(length),
      xAxisVisible(xAxisVisible), xAxisThickness(xAxisThickness), xAxisColor(xAxisColor),
      yAxisVisible(yAxisVisible), yAxisThickness(yAxisThickness), yAxisColor(yAxisColor),
      zAxisVisible(zAxisVisible), zAxisThickness(zAxisThickness), zAxisColor(zAxisColor) {
  }
